...
export const CompanyDeleteDialog = (props: ICompanyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="greatEscapeAdminUiApp.company.delete.question">
        <Translate contentKey="greatEscapeAdminUiApp.company.delete.question" interpolate={{ id: companyEntity.id }}>

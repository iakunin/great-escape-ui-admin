...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="greatEscapeAdminUiApp.location.delete.question">
        <Translate contentKey="greatEscapeAdminUiApp.location.delete.question" interpolate={{ id: locationEntity.id }}>

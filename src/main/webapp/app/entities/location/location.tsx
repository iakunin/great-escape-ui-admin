  ...
  return (
    <div>
      <h2 id="location-heading">
        <Translate contentKey="greatEscapeAdminUiApp.location.home.title">Locations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="greatEscapeAdminUiApp.location.home.createLabel">Create new Location</Translate>
        </Link>
      </h2>
          ...
          {locationList && locationList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('address')}>
                    <Translate contentKey="greatEscapeAdminUiApp.location.address">Address</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('addressExplanation')}>
                    <Translate contentKey="greatEscapeAdminUiApp.location.addressExplanation">Address Explanation</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="greatEscapeAdminUiApp.location.city">City</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {locationList.map((location, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{location.addressExplanation}</td>
                    <td>{location.cityTitle ? <Link to={`city/${location.cityId}`}>{location.cityTitle}</Link> : ''}</td>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="greatEscapeAdminUiApp.location.home.notFound">No Locations found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>

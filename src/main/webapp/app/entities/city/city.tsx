...
export const City = (props: ICityProps) => {
  ...
  return (
    <div>
      <h2 id="city-heading">
        <Translate contentKey="greatEscapeAdminUiApp.city.home.title">Cities</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="greatEscapeAdminUiApp.city.home.createLabel">Create new City</Translate>
        </Link>
      </h2>
          ...
          {cityList && cityList.length > 0 ? (
              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('slug')}>
                    <Translate contentKey="greatEscapeAdminUiApp.city.slug">Slug</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('title')}>
                    <Translate contentKey="greatEscapeAdminUiApp.city.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('timezone')}>
                    <Translate contentKey="greatEscapeAdminUiApp.city.timezone">Timezone</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="greatEscapeAdminUiApp.city.home.notFound">No Cities found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>

...
export const BookingDeleteDialog = (props: IBookingDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="greatEscapeAdminUiApp.booking.delete.question">
        <Translate contentKey="greatEscapeAdminUiApp.booking.delete.question" interpolate={{ id: bookingEntity.id }}>
